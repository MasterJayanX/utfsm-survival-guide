...
- Sigla: INF-280
- Nivel de dificultad según estudiantes: 6+k/10, k=randint(0,3)
- Créditos USM: 3
- Créditos SCT: 5
...
- Regresión Lineal (Tema 9) (Ahora solo se evalúa en el Certamen Recuerativo y reemplaza un tema a elección)
...
$$
NC = \frac{{T2 + T3 + T4 + T5 + T6 + T7 + T8}}{7}
$$
...
- Casi nadie pasó el C2 (promedio 10 en los temas 4 y 5).
- El que sacó 60 y 100 en los temas 4 y 5 es un maldito genio.
- Solo 6 personas pasaron sin el recuperativo.
- Ñanculef se enreda con los ejercicios.
- YAYAYA, VAYAN SUBIENDO LAS NOTAS (nosotros después de cada certamen, además de que entregaron la nota del CR después del cierre del semestre).
