...
Cuando estén logeados (inicien sesión) en github, se van al [repositorio del manual](https://github.com/masterjayanx/utfsm-survival-guide) o al [repositorio antiguo](https://github.com/Zer0-Creativity/utfsm-survival-guide), en el recuadro que dice *master* deben buscar ***development*** e ir hacia la carpeta *pages -> [semestre que desean modificar]*:
